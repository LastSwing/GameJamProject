...
public class Child : BasicActor {

	public Child() { }

	public Child(float _pressValue, float _harmonyValue, float _moneyValue, float _healthyValue) : base(_pressValue, _harmonyValue, _moneyValue, _healthyValue) { }
